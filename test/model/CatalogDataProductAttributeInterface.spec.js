...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.CatalogDataProductAttributeInterface();
  });
  ...
  describe('CatalogDataProductAttributeInterface', function() {
    it('should create an instance of CatalogDataProductAttributeInterface', function() {
      ...
      //var instane = new magento.CatalogDataProductAttributeInterface();
      //expect(instance).to.be.a(magento.CatalogDataProductAttributeInterface);
    });
