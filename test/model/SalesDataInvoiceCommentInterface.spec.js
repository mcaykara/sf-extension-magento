...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.SalesDataInvoiceCommentInterface();
  });
  ...
  describe('SalesDataInvoiceCommentInterface', function() {
    it('should create an instance of SalesDataInvoiceCommentInterface', function() {
      ...
      //var instane = new magento.SalesDataInvoiceCommentInterface();
      //expect(instance).to.be.a(magento.SalesDataInvoiceCommentInterface);
    });
