...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.FrameworkFilter();
  });
  ...
  describe('FrameworkFilter', function() {
    it('should create an instance of FrameworkFilter', function() {
      // uncomment below and update the code to test FrameworkFilter
      //var instane = new magento.FrameworkFilter();
      //expect(instance).to.be.a(magento.FrameworkFilter);
    });
