...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.StoreDataGroupInterface();
  });
  ...
  describe('StoreDataGroupInterface', function() {
    it('should create an instance of StoreDataGroupInterface', function() {
      ...
      //var instane = new magento.StoreDataGroupInterface();
      //expect(instance).to.be.a(magento.StoreDataGroupInterface);
    });
    ...
    it('should have the property rootCategoryId (base name: "rootCategoryId")', function() {
      // uncomment below and update the code to test the property rootCategoryId
      //var instane = new magento.StoreDataGroupInterface();
      //expect(instance).to.be();
    });

    it('should have the property defaultStoreId (base name: "defaultStoreId")', function() {
