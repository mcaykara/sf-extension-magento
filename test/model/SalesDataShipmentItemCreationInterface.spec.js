...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.SalesDataShipmentItemCreationInterface();
  });
  ...
  describe('SalesDataShipmentItemCreationInterface', function() {
    it('should create an instance of SalesDataShipmentItemCreationInterface', function() {
      // uncomment below and update the code to test SalesDataShipmentItemCreationInterface
      //var instane = new magento.SalesDataShipmentItemCreationInterface();
      //expect(instance).to.be.a(magento.SalesDataShipmentItemCreationInterface);
    });
