...
(function(root, factory) {
  ...
  describe('Body91', function() {
    it('should create an instance of Body91', function() {
      // uncomment below and update the code to test Body91
      //var instane = new magento.Body91();
      //expect(instance).to.be.a(magento.Body91);
    });
