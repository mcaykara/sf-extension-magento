...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.CatalogDataProductTierPriceInterface();
  });
  ...
  describe('CatalogDataProductTierPriceInterface', function() {
    it('should create an instance of CatalogDataProductTierPriceInterface', function() {
      // uncomment below and update the code to test CatalogDataProductTierPriceInterface
      //var instane = new magento.CatalogDataProductTierPriceInterface();
      //expect(instance).to.be.a(magento.CatalogDataProductTierPriceInterface);
    });
