...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.QuoteDataPaymentInterface();
  });
  ...
  describe('QuoteDataPaymentInterface', function() {
    it('should create an instance of QuoteDataPaymentInterface', function() {
      // uncomment below and update the code to test QuoteDataPaymentInterface
      //var instane = new magento.QuoteDataPaymentInterface();
      //expect(instance).to.be.a(magento.QuoteDataPaymentInterface);
    });
