...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.CustomerDataRegionInterface();
  });
  ...
  describe('CustomerDataRegionInterface', function() {
    it('should create an instance of CustomerDataRegionInterface', function() {
      // uncomment below and update the code to test CustomerDataRegionInterface
      //var instane = new magento.CustomerDataRegionInterface();
      //expect(instance).to.be.a(magento.CustomerDataRegionInterface);
    });
