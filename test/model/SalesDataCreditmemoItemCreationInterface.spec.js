...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.SalesDataCreditmemoItemCreationInterface();
  });
  ...
  describe('SalesDataCreditmemoItemCreationInterface', function() {
    it('should create an instance of SalesDataCreditmemoItemCreationInterface', function() {
      // uncomment below and update the code to test SalesDataCreditmemoItemCreationInterface
      //var instane = new magento.SalesDataCreditmemoItemCreationInterface();
      //expect(instance).to.be.a(magento.SalesDataCreditmemoItemCreationInterface);
    });
