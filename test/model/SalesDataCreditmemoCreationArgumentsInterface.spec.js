...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.SalesDataCreditmemoCreationArgumentsInterface();
  });
  ...
  describe('SalesDataCreditmemoCreationArgumentsInterface', function() {
    it('should create an instance of SalesDataCreditmemoCreationArgumentsInterface', function() {
      // uncomment below and update the code to test SalesDataCreditmemoCreationArgumentsInterface
      //var instane = new magento.SalesDataCreditmemoCreationArgumentsInterface();
      //expect(instance).to.be.a(magento.SalesDataCreditmemoCreationArgumentsInterface);
    });
