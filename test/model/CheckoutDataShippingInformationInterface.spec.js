...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.CheckoutDataShippingInformationInterface();
  });
  ...
  describe('CheckoutDataShippingInformationInterface', function() {
    it('should create an instance of CheckoutDataShippingInformationInterface', function() {
      ...
      //var instane = new magento.CheckoutDataShippingInformationInterface();
      //expect(instance).to.be.a(magento.CheckoutDataShippingInformationInterface);
    });
