...
(function(root, factory) {
  ...
  describe('Body88', function() {
    it('should create an instance of Body88', function() {
      // uncomment below and update the code to test Body88
      //var instane = new magento.Body88();
      //expect(instance).to.be.a(magento.Body88);
    });
