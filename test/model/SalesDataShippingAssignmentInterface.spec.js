...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.SalesDataShippingAssignmentInterface();
  });
  ...
  describe('SalesDataShippingAssignmentInterface', function() {
    it('should create an instance of SalesDataShippingAssignmentInterface', function() {
      // uncomment below and update the code to test SalesDataShippingAssignmentInterface
      //var instane = new magento.SalesDataShippingAssignmentInterface();
      //expect(instance).to.be.a(magento.SalesDataShippingAssignmentInterface);
    });
