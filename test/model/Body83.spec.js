...
(function(root, factory) {
  ...
  describe('Body83', function() {
    it('should create an instance of Body83', function() {
      // uncomment below and update the code to test Body83
      //var instane = new magento.Body83();
      //expect(instance).to.be.a(magento.Body83);
    });
