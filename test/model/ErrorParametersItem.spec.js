...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.ErrorParametersItem();
  });
  ...
  describe('ErrorParametersItem', function() {
    it('should create an instance of ErrorParametersItem', function() {
      // uncomment below and update the code to test ErrorParametersItem
      //var instane = new magento.ErrorParametersItem();
      //expect(instance).to.be.a(magento.ErrorParametersItem);
    });
