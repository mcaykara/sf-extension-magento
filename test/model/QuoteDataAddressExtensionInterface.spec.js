...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.QuoteDataAddressExtensionInterface();
  });
  ...
  describe('QuoteDataAddressExtensionInterface', function() {
    it('should create an instance of QuoteDataAddressExtensionInterface', function() {
      ...
      //var instane = new magento.QuoteDataAddressExtensionInterface();
      //expect(instance).to.be.a(magento.QuoteDataAddressExtensionInterface);
    });

    it('should have the property giftRegistryId (base name: "giftRegistryId")', function() {
