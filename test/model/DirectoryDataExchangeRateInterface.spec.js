...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.DirectoryDataExchangeRateInterface();
  });
  ...
  describe('DirectoryDataExchangeRateInterface', function() {
    it('should create an instance of DirectoryDataExchangeRateInterface', function() {
      // uncomment below and update the code to test DirectoryDataExchangeRateInterface
      //var instane = new magento.DirectoryDataExchangeRateInterface();
      //expect(instance).to.be.a(magento.DirectoryDataExchangeRateInterface);
    });
