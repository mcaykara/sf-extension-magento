...
(function(root, factory) {
  ...
  describe('Body86', function() {
    it('should create an instance of Body86', function() {
      // uncomment below and update the code to test Body86
      //var instane = new magento.Body86();
      //expect(instance).to.be.a(magento.Body86);
    });
