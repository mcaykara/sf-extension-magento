...
(function(root, factory) {
  ...
  describe('Body39', function() {
    it('should create an instance of Body39', function() {
      // uncomment below and update the code to test Body39
      //var instane = new magento.Body39();
      //expect(instance).to.be.a(magento.Body39);
    });
