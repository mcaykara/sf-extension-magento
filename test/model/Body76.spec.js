...
(function(root, factory) {
  ...
  describe('Body76', function() {
    it('should create an instance of Body76', function() {
      // uncomment below and update the code to test Body76
      //var instane = new magento.Body76();
      //expect(instance).to.be.a(magento.Body76);
    });
