...
(function(root, factory) {
  ...
  describe('Body84', function() {
    it('should create an instance of Body84', function() {
      // uncomment below and update the code to test Body84
      //var instane = new magento.Body84();
      //expect(instance).to.be.a(magento.Body84);
    });
