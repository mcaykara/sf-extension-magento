...
(function(root, factory) {
  ...
  describe('Body87', function() {
    it('should create an instance of Body87', function() {
      // uncomment below and update the code to test Body87
      //var instane = new magento.Body87();
      //expect(instance).to.be.a(magento.Body87);
    });
