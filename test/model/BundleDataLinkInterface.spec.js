...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.BundleDataLinkInterface();
  });
  ...
  describe('BundleDataLinkInterface', function() {
    it('should create an instance of BundleDataLinkInterface', function() {
      ...
      //var instane = new magento.BundleDataLinkInterface();
      //expect(instance).to.be.a(magento.BundleDataLinkInterface);
    });
    ...
    it('should have the property canChangeQuantity (base name: "canChangeQuantity")', function() {
