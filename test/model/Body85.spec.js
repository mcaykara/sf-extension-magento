...
(function(root, factory) {
  ...
  describe('Body85', function() {
    it('should create an instance of Body85', function() {
      // uncomment below and update the code to test Body85
      //var instane = new magento.Body85();
      //expect(instance).to.be.a(magento.Body85);
    });
