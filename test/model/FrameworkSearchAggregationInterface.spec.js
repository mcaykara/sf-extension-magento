...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.FrameworkSearchAggregationInterface();
  });
  ...
  describe('FrameworkSearchAggregationInterface', function() {
    it('should create an instance of FrameworkSearchAggregationInterface', function() {
      ...
      //var instane = new magento.FrameworkSearchAggregationInterface();
      //expect(instance).to.be.a(magento.FrameworkSearchAggregationInterface);
    });
