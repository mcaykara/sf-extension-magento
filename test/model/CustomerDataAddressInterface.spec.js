...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.CustomerDataAddressInterface();
  });
  ...
  describe('CustomerDataAddressInterface', function() {
    it('should create an instance of CustomerDataAddressInterface', function() {
      // uncomment below and update the code to test CustomerDataAddressInterface
      //var instane = new magento.CustomerDataAddressInterface();
      //expect(instance).to.be.a(magento.CustomerDataAddressInterface);
    });
