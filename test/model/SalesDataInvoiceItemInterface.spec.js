...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.SalesDataInvoiceItemInterface();
  });
  ...
  describe('SalesDataInvoiceItemInterface', function() {
    it('should create an instance of SalesDataInvoiceItemInterface', function() {
      // uncomment below and update the code to test SalesDataInvoiceItemInterface
      //var instane = new magento.SalesDataInvoiceItemInterface();
      //expect(instance).to.be.a(magento.SalesDataInvoiceItemInterface);
    });
