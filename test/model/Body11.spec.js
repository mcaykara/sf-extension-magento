...
(function(root, factory) {
  ...
  describe('Body11', function() {
    it('should create an instance of Body11', function() {
      // uncomment below and update the code to test Body11
      //var instane = new magento.Body11();
      //expect(instance).to.be.a(magento.Body11);
    });
