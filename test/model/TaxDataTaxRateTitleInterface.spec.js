...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.TaxDataTaxRateTitleInterface();
  });
  ...
  describe('TaxDataTaxRateTitleInterface', function() {
    it('should create an instance of TaxDataTaxRateTitleInterface', function() {
      // uncomment below and update the code to test TaxDataTaxRateTitleInterface
      //var instane = new magento.TaxDataTaxRateTitleInterface();
      //expect(instance).to.be.a(magento.TaxDataTaxRateTitleInterface);
    });
