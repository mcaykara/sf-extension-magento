...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.QuoteDataAddressInterface();
  });
  ...
  describe('QuoteDataAddressInterface', function() {
    it('should create an instance of QuoteDataAddressInterface', function() {
      // uncomment below and update the code to test QuoteDataAddressInterface
      //var instane = new magento.QuoteDataAddressInterface();
      //expect(instance).to.be.a(magento.QuoteDataAddressInterface);
    });
    ...
    it('should have the property sameAsBilling (base name: "sameAsBilling")', function() {
      // uncomment below and update the code to test the property sameAsBilling
      //var instane = new magento.QuoteDataAddressInterface();
      //expect(instance).to.be();
    });
    ...
    it('should have the property saveInAddressBook (base name: "saveInAddressBook")', function() {
      // uncomment below and update the code to test the property saveInAddressBook
      //var instane = new magento.QuoteDataAddressInterface();
      //expect(instance).to.be();
    });
