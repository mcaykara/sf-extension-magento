...
(function(root, factory) {
  ...
  describe('Body89', function() {
    it('should create an instance of Body89', function() {
      // uncomment below and update the code to test Body89
      //var instane = new magento.Body89();
      //expect(instance).to.be.a(magento.Body89);
    });
