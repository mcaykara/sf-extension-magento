...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.CheckoutDataPaymentDetailsInterface();
  });
  ...
  describe('CheckoutDataPaymentDetailsInterface', function() {
    it('should create an instance of CheckoutDataPaymentDetailsInterface', function() {
      // uncomment below and update the code to test CheckoutDataPaymentDetailsInterface
      //var instane = new magento.CheckoutDataPaymentDetailsInterface();
      //expect(instance).to.be.a(magento.CheckoutDataPaymentDetailsInterface);
    });
