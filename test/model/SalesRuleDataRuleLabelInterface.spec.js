...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new magento.SalesRuleDataRuleLabelInterface();
  });
  ...
  describe('SalesRuleDataRuleLabelInterface', function() {
    it('should create an instance of SalesRuleDataRuleLabelInterface', function() {
      // uncomment below and update the code to test SalesRuleDataRuleLabelInterface
      //var instane = new magento.SalesRuleDataRuleLabelInterface();
      //expect(instance).to.be.a(magento.SalesRuleDataRuleLabelInterface);
    });
