...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.magento.SalesRuleDataCouponMassDeleteResultInterface = factory(root.magento.ApiClient);
  }
   ...
   */
  var exports = function(failedItems, missingItems) {
    var _this = this;

    _this['failedItems'] = failedItems;
    _this['missingItems'] = missingItems;
  };
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('failedItems')) {
        obj['failedItems'] = ApiClient.convertToType(data['failedItems'], ['String']);
      }
      if (data.hasOwnProperty('missingItems')) {
        obj['missingItems'] = ApiClient.convertToType(data['missingItems'], ['String']);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<String>} failedItems
   */
  exports.prototype['failedItems'] = undefined;
  /**
   * List of missing items.
   * @member {Array.<String>} missingItems
   */
  exports.prototype['missingItems'] = undefined;
