...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.magento.CatalogInventoryStockStatusCriteriaInterface = factory(root.magento.ApiClient, root.magento.FrameworkCriteriaInterface);
  }
  ...
  /**
   * The CatalogInventoryStockStatusCriteriaInterface model module.
   * @module model/CatalogInventoryStockStatusCriteriaInterface
   * @version 2.0
   */

  /**
   * Constructs a new <code>CatalogInventoryStockStatusCriteriaInterface</code>.
   * Interface StockStatusCriteriaInterface
   * @alias module:model/CatalogInventoryStockStatusCriteriaInterface
   * @class
  ...
  /**
   * Constructs a <code>CatalogInventoryStockStatusCriteriaInterface</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CatalogInventoryStockStatusCriteriaInterface} obj Optional instance to populate.
   * @return {module:model/CatalogInventoryStockStatusCriteriaInterface} The populated <code>CatalogInventoryStockStatusCriteriaInterface</code> instance.
   */
