...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FrameworkSearchCriteriaInterface', 'model/RmaDataCommentInterface'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FrameworkSearchCriteriaInterface'), require('./RmaDataCommentInterface'));
  } else {
    // Browser globals (root is window)
    if (!root.magento) {
      root.magento = {};
    }
    root.magento.RmaDataCommentSearchResultInterface = factory(root.magento.ApiClient, root.magento.FrameworkSearchCriteriaInterface, root.magento.RmaDataCommentInterface);
  }
}(this, function(ApiClient, FrameworkSearchCriteriaInterface, RmaDataCommentInterface) {
  'use strict';
