...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.magento.Body116 = factory(root.magento.ApiClient, root.magento.GiftMessageDataMessageInterface);
  }
  ...
  /**
   * The Body116 model module.
   * @module model/Body116
   * @version 2.0
   */

  /**
   * Constructs a new <code>Body116</code>.
   * @alias module:model/Body116
   * @class
  ...
  /**
   * Constructs a <code>Body116</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Body116} obj Optional instance to populate.
   * @return {module:model/Body116} The populated <code>Body116</code> instance.
   */
